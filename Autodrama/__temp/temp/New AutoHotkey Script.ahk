...
hFont := GDI_ModifyFont( 0, "FontFace=Product Sans, Height=24" )


GdiPlus( "Startup" )

hBitmap := GdiPlus_hBitmapFromBuffer( Banner, DllRead( Banner, "AHK.DLL","Images","BANNER.JPG" ) )
GdiPlus( "Shutdown" )

;Gui, Add, Picture,x0 y0 w600 h150 hwndhPic 0x20E
Gui, Add, Picture,x0 y0 w583 h600 hwndhPic 0x20E
Gui, Add, Text, w520 h90 hwndhText Center, Product Sans
GuiLoadPicture(hPic)
...
{
    Global
    static STM_SETIMAGE:=0x172, IMAGE_BITMAP:=0x0
...
GDI_ModifyFont( hFont=0, Options="" ) { ;                                          By SKAN
